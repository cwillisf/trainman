...
#
fanprofiles=[[640,660,680,700,720,740,760,780,800],\
...
def set_display_text():
    ...
    #print "message2",messagelist[2],"xxxx"
...
while True:
    ...
    if (x % 30) == 0:
        roomtemp = get_owserver_tempf('192.168.62.17','iso.3.6.1.4.1.31440.10.5.1.1.1','panda')
